...
export function WhitelistForm({ onDone }: { onDone?: () => void }) {
  ...
  if (done) {
    return (
      <div className="flex flex-col items-center gap-4 py-8 text-center">
        ...
        <h3 className="text-2xl font-semibold tracking-tight">You're whitelisted!</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <div className="rounded-lg border border-primary/25 bg-primary/5 p-4">
        ...
        <div className="mt-3 flex items-start gap-2.5">
          <Checkbox
            ...
            className="mt-0.5"
          />
          <Label htmlFor="followed" className="text-sm leading-snug font-normal">
      ...
      <Button type="submit" disabled={!canSubmit} className="w-full font-semibold">
